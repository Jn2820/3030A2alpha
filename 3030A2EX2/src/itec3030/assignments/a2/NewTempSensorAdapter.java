...
public class NewTempSensorAdapter implements TemperatureSensor, AbstractNewTempSensorAdapter, Observer{

	private NewTempSensorDriver newTempSensorDriver= new NewTempSensorDriver();;
	...
	System.out.println( "Sensor newtemp (" + this.name + ") receiving new temperature: " + this.getReading());
	...
	System.out.println( "Sensor update(" + this.name + ") receiving new temperature: " + this.getReading());
